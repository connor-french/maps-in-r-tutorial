...
All code can be executed by copying and pasting the below lines into an R console. You can download R for your system [here](https://cran.r-project.org/). However, if you have [RStudio](https://www.rstudio.com/products/rstudio/download/), click [here](https://github.com/connor-french/maps-in-r-tutorial/archive/master.zip) to download the code for the tutorial and run the notebook. Just unzip the file and double-click the .Rmd file! 
...
Since I am partial to frogs, we're going to plot the distribution of the Rufous Frog, which is distributed across South America. 
